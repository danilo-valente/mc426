...
function(GENERATE_ARDUINO_FIRMWARE INPUT_NAME)
    ...
    set(ORDERED_LIBS uno_ArduinoThread
                     uno_Server
                     uno_Ethernet
                     uno_src
                     uno_SPI
    ...
    list(LENGTH ALL_LIBS AL_LEN)
    list(LENGTH ORDERED_LIBS OL_LEN)
    if (AL_LEN EQUAL OL_LEN)
        set(ALL_LIBS ${ORDERED_LIBS})
    else()
        ...
        foreach(LIB ${ORDERED_LIBS})
            message(Ordered:${LIB})
        endforeach()
        message(FATAL_ERROR "Must update ORDERED_LIBS")
    endif()
...
#            add_dependencies(${TARGET_LIB_NAME} ${DEP_LIB_SRCS})    # Hacky
